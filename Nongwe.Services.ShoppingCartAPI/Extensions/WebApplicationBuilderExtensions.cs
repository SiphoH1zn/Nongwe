...
namespace Nongwe.Services.ShoppingCartAPI.Extensions
{
    public static class WebApplicationBuilderExtensions
    {
        public static WebApplicationBuilder AddAppAuttetication(this WebApplicationBuilder builder)
        {
            ...
            }).AddJwtBearer(x =>
            {
                x.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidAudience = audience, // Added this line
                };
            });
